...
( override val uuid: resolver.api.taggedTypes.DescriptionBoxUUID,
  ...
  instanceRelationshipEnumerationRestrictions: S[omf#InstanceRelationshipEnumerationRestriction],
  instanceRelationshipValueRestrictions: S[omf#InstanceRelationshipValueRestriction],
  instanceRelationshipExistentialRangeRestrictions: S[omf#InstanceRelationshipExistentialRangeRestriction],
  instanceRelationshipUniversalRangeRestrictions: S[omf#InstanceRelationshipUniversalRangeRestriction],
